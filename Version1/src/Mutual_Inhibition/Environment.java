...
public void initialize(){
  ...
  MovingObj[PREDATOR] = new MovingObject_Struct(false,350,20,20,0,250,Math.PI*2/3,new MovingPara_Struct(0,0,100));
  StaticObj[FOOD] = new StaticObject_Struct(10,10,200,200,0,6);
  StaticObj[SHELTER] = new StaticObject_Struct(50,50,120,120,0);

  rgui = new robotGUI(this, (int)WallX, (int)WallY);
  rgui.start();
...
public void MoveBackward(int index, double speed, double noise){
MovingObj[index].MovingPara.movingType=2;
MovingObj[index].MovingPara.speed=speed;
MovingObj[index].MovingPara.noiseFactor=noise;
}

public void CWRotation(int index, double speed, double noise){
MovingObj[index].MovingPara.movingType=3;
MovingObj[index].MovingPara.speed=speed;
MovingObj[index].MovingPara.noiseFactor=noise;
}

public void CCRotation(int index, double speed, double noise){
MovingObj[index].MovingPara.movingType=4;
MovingObj[index].MovingPara.speed=speed;
MovingObj[index].MovingPara.noiseFactor=noise;
}
