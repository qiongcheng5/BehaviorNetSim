...
public robotGUI(Environment env, int WallX, int WallY){
...
class robotPanel extends JPanel{
  ...
  public robotPanel(Environment env,int wx, int wy) {
    ...
    WallX = wx;
    WallY = wy;
    robotImage =  Toolkit.getDefaultToolkit().getImage("bluecar.gif");
    predatorImage =  Toolkit.getDefaultToolkit().getImage("greencar.gif");
